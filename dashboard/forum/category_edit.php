...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $db->prepare("UPDATE forum_categories SET name=?, slug=? WHERE id=?");
    $stmt->execute([$name, $slug, $id]);

    echo "<script>alert('Kategorie aktualisiert!'); window.location='/dashboard/forum/list.php';</script>";
}
?>
