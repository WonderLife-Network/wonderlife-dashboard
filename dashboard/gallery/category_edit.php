...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $db->prepare("UPDATE gallery_categories SET name=?, slug=? WHERE id=?");
    $stmt->execute([$name, $slug, $id]);

    echo "<script>alert('Kategorie aktualisiert!'); window.location='/dashboard/gallery/categories.php';</script>";
}
?>
